...
function AdminLayout() {
  ...
  const navItems = [
    ...
    { to: '/admin/branch-assignment', label: 'Branch Assignment', icon: '🏢' },
    ...
    <div style={styles.container}>
      ...
      <BSNavbar bg={theme === 'light' ? 'light' : 'dark'} variant={theme === 'light' ? 'light' : 'dark'} expand="lg">
        <Container fluid>
          ...
          <BSNavbar.Brand href="/admin/dashboard" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: 'auto' }}>
            <NotificationBell />
            {/* Navbar Avatar */}
            <div style={{ cursor: 'pointer' }} onClick={() => navigate('/admin/profile')}>
              {user?.profilePicture ? (
                <img 
      ...
      <Offcanvas show={showSidebar} onHide={handleClose} placement="start">
        ...
        <Offcanvas.Body>
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>Administrator</p>
          </div>
